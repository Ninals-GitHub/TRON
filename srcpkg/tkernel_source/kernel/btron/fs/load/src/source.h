 ...
 *       program load source (e.g., files)
 */

#ifndef _T2EX_LOAD_SOURCE_
#define _T2EX_LOAD_SOURCE_

#define USE_FILELOADER	1
#define USE_MEMLOADER	1
...
typedef struct LoadSource {
	...
	ER	(*close)(struct LoadSource* ldr);
