 ...
 * RAM area boundaries
 */
#define	REALMEMORY_TOP	0x30000000
#define	REALMEMORY_END	0x40000000

/*
 * ROM area boundaries
 */
#define	ROM_TOP		0x70000000
#define	ROM_END		0x71000000

/*
 * Returns true if addr is in RAM area
 */
#define	isRAM(addr)		(  (UW)(addr) >= REALMEMORY_TOP \
				&& (UW)(addr) <  REALMEMORY_END )
