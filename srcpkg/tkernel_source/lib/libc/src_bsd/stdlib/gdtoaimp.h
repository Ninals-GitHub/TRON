...
#if defined(IEEE_8087) && _BYTE_ORDER != _BIG_ENDIAN
 ...
 */
#if ( defined(IEEE_8087) + defined(VAX) ) && _BYTE_ORDER != _BIG_ENDIAN
...
#ifdef _T2EX
/* For T2EX, memory resource is very important.
   Hence, private memory for Balloc only shall be removed */
