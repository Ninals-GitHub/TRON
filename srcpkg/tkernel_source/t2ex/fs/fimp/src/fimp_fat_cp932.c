...
#define CP932_HANKATA_START	(0xa1)
#define CP932_HANKATA_END	(0xdf)
#define UNICODE_HANKATA_START	(0xff61)
#define UNICODE_HANKATA_END	(0xff9f)
#define UNICODE_MAX		(0xffe5)
#define HANKATA_OFS		(UNICODE_HANKATA_START - CP932_HANKATA_START)
#define UNDEFINED_MARK		(0x5f)		/* Character for unknown */

/* 
 *  First character check table
 */
#define UNDEF		(0)
#define HKANA		(1)
LOCAL	const	UB	C0Chk[ASCII_MAX + 1] = {
	UNDEF, 0x81,  0x81,  0x81,  0x81,  UNDEF, UNDEF, 0x83,	/* 80-87 */
	0x83,  0x83,  0x83,  0x83,  0x83,  0x83,  0x83,  0x83,	/* 88-8f */
	0x83,  0x83,  0x83,  0x83,  0x83,  0x83,  0x83,  0x83,	/* 90-97 */
	0x83,  0x83,  0x83,  0x83,  0x83,  0x83,  0x83,  0x83,	/* 98-9f */
	UNDEF, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* A0-A7 */
	HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* A8-Af */
	HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* B0-B7 */
	HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* B8-Bf */
	HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* C0-C7 */
	HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* C8-Cf */
	HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* D0-D7 */
	HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA, HKANA,	/* D8-Df */
	0xc3,  0xc3,  0xc3,  0xc3,  0xc3,  0xc3,  0xc3,  0xc3,	/* E0-E7 */
	0xc3,  0xc3,  0xc3,  UNDEF, UNDEF, 0xc5,  0xc5,  UNDEF,	/* E8-Ef */
	UNDEF, UNDEF, UNDEF, UNDEF, UNDEF, UNDEF, UNDEF, UNDEF,	/* F0-F7 */
	UNDEF, UNDEF, 0xd0,  0xd0,  0xd0,  UNDEF, UNDEF, UNDEF,	/* F8-Ff */
};

/* 
 *  CP932 to Unicode conversion table 
 */
#define C0_MAX		(45)
#define C1_MAX		(190)
LOCAL	const	UH	CP932ToUnicodeTable[C0_MAX][C1_MAX] = {
	{	/* 0 (0x81xx) */
	...
	0x0000, 0x0000, 0x0000, 0x0000, 0x25ef, 0xffff,
	}, {	/* 1 (0x82xx) */
	0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
	...
	0x5f15, 0x98f2, 0x6deb, 0x80e4, 0x852d, 0xffff,
	}, {	/* 6 (0x89xx) */
	...
	0x6062, 0x61d0, 0x6212, 0x62d0, 0x6539, 0xffff,
	}, {	/* 7 (0x8axx) */
	...
	0x65d7, 0x65e2, 0x671f, 0x68cb, 0x68c4, 0xffff,
	}, {	/* 8 (0x8bxx) */
	...
	0x4e32, 0x6adb, 0x91e7, 0x5c51, 0x5c48, 0xffff,
	}, {	/* 9 (0x8cxx) */
	...
	0x52b9, 0x52fe, 0x539a, 0x53e3, 0x5411, 0xffff,
	}, {	/* 10 (0x8dxx) */
	...
	0x9bad, 0x7b39, 0x5319, 0x518a, 0x5237, 0xffff,
	}, {	/* 11 (0x8exx) */
	...
	0x7dac, 0x9700, 0x56da, 0x53ce, 0x5468, 0xffff,
	}, {	/* 12 (0x8fxx) */
	...
	0x91b8, 0x9320, 0x5631, 0x57f4, 0x98fe, 0xffff,
	}, {	/* 13 (0x90xx) */
	...
	0x717d, 0x65cb, 0x7a7f, 0x7bad, 0x7dda, 0xffff,
	}, {	/* 14 (0x91xx) */
	...
	0x8afe, 0x8338, 0x51e7, 0x86f8, 0x53ea, 0xffff,
	}, {	/* 15 (0x92xx) */
	...
	0x8247, 0x8a02, 0x8ae6, 0x8e44, 0x9013, 0xffff,
	}, {	/* 16 (0x93xx) */
	...
	0x8679, 0x5eff, 0x65e5, 0x4e73, 0x5165, 0xffff,
	}, {	/* 17 (0x94xx) */
	...
	0x6787, 0x6bd8, 0x7435, 0x7709, 0x7f8e, 0xffff,
	}, {	/* 18 (0x95xx) */
	...
	0x62b1, 0x6367, 0x653e, 0x65b9, 0x670b, 0xffff,
	}, {	/* 19 (0x96xx) */
	...
	0x9453, 0x6109, 0x6108, 0x6cb9, 0x7652, 0xffff,
	}, {	/* 20 (0x97xx) */
	...
	0x6f23, 0x7149, 0x7c3e, 0x7df4, 0x806f, 0xffff,
	}, {	/* 21 (0x98xx) */
	...
	0x5080, 0x509a, 0x5085, 0x50b4, 0x50b2, 0xffff,
	}, {	/* 22 (0x99xx) */
	...
	0x54a5, 0x54ac, 0x54c4, 0x54c8, 0x54a8, 0xffff,
	}, {	/* 23 (0x9axx) */
	...
	0x5962, 0x5960, 0x5967, 0x596c, 0x5969, 0xffff,
	}, {	/* 24 (0x9bxx) */
	...
	0x5ec1, 0x5ec2, 0x5ec8, 0x5ed0, 0x5ecf, 0xffff,
	}, {	/* 25 (0x9cxx) */
	...
	0x6209, 0x620d, 0x620c, 0x6214, 0x621b, 0xffff,
	}, {	/* 26 (0x9dxx) */
	...
	0x66c1, 0x66b9, 0x66c9, 0x66be, 0x66bc, 0xffff,
	}, {	/* 27 (0x9exx) */
	...
	0x6a8d, 0x6aa0, 0x6a84, 0x6aa2, 0x6aa3, 0xffff,
	}, {	/* 28 (0x9fxx) */
	...
	0x6ef2, 0x6f31, 0x6eef, 0x6f32, 0x6ecc, 0xffff,
	}, {	/* 29 (0xe0xx) */
	...
	0x74a7, 0x74ca, 0x74cf, 0x74d4, 0x73f1, 0xffff,
	}, {	/* 30 (0xe1xx) */
	...
	0x78be, 0x78bc, 0x78c5, 0x78ca, 0x78ec, 0xffff,
	}, {	/* 31 (0xe2xx) */
	...
	0x7cf2, 0x7cf4, 0x7cf6, 0x7cfa, 0x7d06, 0xffff,
	}, {	/* 32 (0xe3xx) */
	...
	0x811b, 0x8129, 0x8123, 0x812f, 0x814b, 0xffff,
	}, {	/* 33 (0xe4xx) */
	...
	0x84fc, 0x8540, 0x8563, 0x8558, 0x8548, 0xffff,
	}, {	/* 34 (0xe5xx) */
	...
	0x8938, 0x894c, 0x891d, 0x8960, 0x895e, 0xffff,
	}, {	/* 35 (0xe6xx) */
	...
	0x8e42, 0x8e35, 0x8e30, 0x8e34, 0x8e4a, 0xffff,
	}, {	/* 36 (0xe7xx) */
	...
	0x92e9, 0x930f, 0x92fa, 0x9344, 0x932e, 0xffff,
	}, {	/* 37 (0xe8xx) */
	...
	0x984f, 0x984b, 0x986b, 0x986f, 0x9870, 0xffff,
	}, {	/* 38 (0xe9xx) */
	...
	0x9d41, 0x9d3f, 0x9d3e, 0x9d46, 0x9d48, 0xffff,
	}, {	/* 39 (0xeaxx) */
	...
	0x7147, 0xfa15, 0x71c1, 0x71fe, 0x72b1, 0xffff,
	}, {	/* 41 (0xeexx) */
	...
	0x2179, 0xffe2, 0xffe4, 0xff07, 0xff02, 0xffff,
	}, {	/* 42 (0xfaxx) */
	...
	0x6c6f, 0x6cda, 0x6d04, 0x6d87, 0x6d6f, 0xffff,
	}, {	/* 43 (0xfbxx) */
	...
	0x9927, 0xfa2c, 0x999e, 0x9a4e, 0x9ad9, 0xffff,
	}, {	/* 44 (0xfcxx) */
...
/*
 *  Convert CP932 to Unicode
 *	Return the byte count of the used CP932 characters.
 */
EXPORT	W	fatEncCP932ToUnicode(const UB cp932[], UW *unicode)
{
	UB	c0, c1, chk;
	UW	uc;
	W	len;
	...
	/* Hankaku-Katakana */
	chk = C0Chk[c0 - (ASCII_MAX + 1)];
	if (chk == HKANA) {
		uc = (UW)c0 + HANKATA_OFS;
		goto exit0;
	}
	...
	/* Convert */
	/* Including 0x7F, but always 0 cause not mapping CP932 */
	uc = CP932ToUnicodeTable[c0 - chk][c1 - 0x40];
	if (uc == 0) uc = UNDEFINED_MARK;
exit0:
	*unicode = uc;
	return len;
}
...
/*
 *  Convert Unicode to CP932
 *	Return the byte count of the CP932 characters.
 */
EXPORT	W	fatEncUnicodeToCP932(UW unicode, UB cp932[ENC_CHAR_MAX])
{
	UH	c0, c1, *ct;
	...
	/* Ascii */
	if (unicode <= ASCII_MAX) {
		c0 = (UB)unicode;
		goto exit0;
	}

	/* Hankaku-Katakana */
	if (UNICODE_HANKATA_START <= unicode
				&& unicode <= UNICODE_HANKATA_END) {
		c0 = (UB)(unicode - HANKATA_OFS);
		goto exit0;
	}

	/* Undefined code */
	if (UNICODE_MAX < unicode) {
		c0 = UNDEFINED_MARK;
		goto exit0;
	}

	/* Convert */
	for (c0 = 0; c0 < C0_MAX; c0++) {
		ct = (UH *)CP932ToUnicodeTable[c0];
		for (c1 = 0; ct[c1] != (UH)unicode && ct[c1] != 0xffff; c1++);
		if (ct[c1] != 0xffff) break;
	}
	c1 += 0x40;
	if (c0 <= 3)		c0 += 0x81;
	else if (c0 <= 28)	c0 += 0x83;
	else if (c0 <= 39)	c0 += 0xc3;
	else if (c0 <= 41)	c0 += 0xc5;
	else if (c0 <= 44)	c0 += 0xd0;
	else {
		c0 = UNDEFINED_MARK;
		c1 = 0;
	}
