/*
 * This file was manually modified though the original NetBSD file was 
...
struct sys_recvmsg_args {
	NET_SO_RECVMSG_PARA a;
};

struct sys_sendmsg_args {
	NET_SO_SENDMSG_PARA a;
};
...
struct sys_recvfrom_args {
	NET_SO_RECVFROM_PARA a;
};

struct sys_accept_args {
	NET_SO_ACCEPT_PARA a;
};

struct sys_getpeername_args {
	NET_SO_GETPEERNAME_PARA a;
};

struct sys_getsockname_args {
	NET_SO_GETSOCKNAME_PARA a;
};

struct sys___socket30_args {
	NET_SO_SOCKET_PARA a;
};
...
struct sys_setsockopt_args {
	NET_SO_SETSOCKOPT_PARA a;
};

struct sys_listen_args {
	NET_SO_LISTEN_PARA a;
};

struct sys_getsockopt_args {
	NET_SO_GETSOCKOPT_PARA a;
};
...
struct sys_sendto_args {
	NET_SO_SENDTO_PARA a;
};

struct sys_shutdown_args {
	NET_SO_SHUTDOWN_PARA a;
};

struct sys_ioctl_args {
	NET__SO_IOCTL_PARA a;
};

struct sys_select_args {
	NET_SO_SELECT_PARA a;
};

struct sys_select_us_args {
	NET_SO_SELECT_US_PARA a;
};

struct sys_select_ms_args {
	NET_SO_SELECT_MS_PARA a;
};

struct sys_gethostname_args {
	NET_SO_GETHOSTNAME_PARA a;
};

struct sys_sethostname_args {
	NET_SO_SETHOSTNAME_PARA a;
};

struct sys_getaddrinfo_args {
	NET_SO_GETADDRINFO_PARA a;
};

struct sys_getaddrinfo_ms_args {
	NET_SO_GETADDRINFO_MS_PARA a;
};

struct sys_getaddrinfo_us_args {
	NET_SO_GETADDRINFO_US_PARA a;
};

struct sys_getnameinfo_args {
	NET_SO_GETNAMEINFO_PARA a;
};

struct sys_getnameinfo_ms_args {
	NET_SO_GETNAMEINFO_MS_PARA a;
};

struct sys_getnameinfo_us_args {
	NET_SO_GETNAMEINFO_US_PARA a;
};

struct sys_sockatmark_args {
	NET_SO_SOCKATMARK_PARA a;
};

struct sys_break_args {
	NET_SO_BREAK_PARA a;
};

struct sys_ifattach_args {
	NET_SO_IFATTACH_PARA a;
};

struct sys_ifdetach_args {
	NET_SO_IFDETACH_PARA a;
};

struct sys_rtlist_args {
	NET_SO_RTLIST_PARA a;
};

struct sys_resctl_args {
	NET_SO_RESCTL_PARA a;
};

struct sys_getifaddrs_args {
	NET_SO_GETIFADDRS_PARA a;
};

struct sys_ifindextoname_args {
	NET_SO_IFINDEXTONAME_PARA a;
};

struct sys_ifnametoindex_args {
	NET_SO_IFNAMETOINDEX_PARA a;
};

struct sys_bpfopen_args {
	NET_SO_BPFOPEN_PARA a;
};

struct sys_tunopen_args {
	NET_SO_TUNOPEN_PARA a;
};

struct sys_fcntl_args {
	NET__SO_FCNTL_PARA a;
};

struct sys_tknmonitor_args {
	syscallarg(char *) buff;
};

struct sys_tknkread_args {
	syscallarg(unsigned int) target;
	syscallarg(const void *) buff;
	syscallarg(unsigned int) len;
	syscallarg(const void *) ptr;
};

struct sys_tkntrace_args {
	syscallarg(int) ops;
	syscallarg(int) sysno;
	syscallarg(int) tid;
};
...
int	sys_recvmsg(struct lwp *, const struct sys_recvmsg_args *, register_t *);
int	sys_select(struct lwp *, const struct sys_select_args *, register_t *);
int	sys_select_us(struct lwp *, const struct sys_select_us_args *, register_t *);
int	sys_select_ms(struct lwp *, const struct sys_select_ms_args *, register_t *);
int	compat_43_sys_send(struct lwp *, const struct compat_43_sys_send_args *, register_t *);
int	sys_sendmsg(struct lwp *, const struct sys_sendmsg_args *, register_t *);
int	sys_sendto(struct lwp *, const struct sys_sendto_args *, register_t *);
int	sys_setsockopt(struct lwp *, const struct sys_setsockopt_args *, register_t *);
...
int	sys_gethostname(struct lwp *, const struct sys_gethostname_args *, register_t *);
int	sys_sethostname(struct lwp *, const struct sys_sethostname_args *, register_t *);
int	sys_getaddrinfo(struct lwp *, const struct sys_getaddrinfo_args *, register_t *);
int	sys_getaddrinfo_ms(struct lwp *, const struct sys_getaddrinfo_ms_args *, register_t *);
int	sys_getaddrinfo_us(struct lwp *, const struct sys_getaddrinfo_us_args *, register_t *);
int	sys_getnameinfo(struct lwp *, const struct sys_getnameinfo_args *, register_t *);
int	sys_getnameinfo_ms(struct lwp *, const struct sys_getnameinfo_ms_args *, register_t *);
int	sys_getnameinfo_us(struct lwp *, const struct sys_getnameinfo_us_args *, register_t *);
int	sys_sockatmark(struct lwp *, const struct sys_sockatmark_args *, register_t *);
int	sys_break(struct lwp *, const struct sys_break_args *, register_t *);
int	sys_ifattach(struct lwp *, const struct sys_ifattach_args *, register_t *);
int	sys_ifdetach(struct lwp *, const struct sys_ifdetach_args *, register_t *);
int	sys_rtlist(struct lwp *, const struct sys_rtlist_args *, register_t *);
int	sys_resctl(struct lwp *, const struct sys_resctl_args *, register_t *);
int	sys_getifaddrs(struct lwp *, const struct sys_getifaddrs_args *, register_t *);
int	sys_ifindextoname(struct lwp *, const struct sys_ifindextoname_args *, register_t *);
int	sys_ifnametoindex(struct lwp *, const struct sys_ifnametoindex_args *, register_t *);

int	sys_bpfopen(struct lwp *, const struct sys_bpfopen_args *, register_t *);
int	sys_tunopen(struct lwp *, const struct sys_tunopen_args *, register_t *);
